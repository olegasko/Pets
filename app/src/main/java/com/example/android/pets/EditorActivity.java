...
public class EditorActivity extends AppCompatActivity
    ...
    private void savePet() {
        ...
        if (mUri == null) {
            ...
            rowId = ContentUris.parseId(mUri);
        } else {
            rowId = getContentResolver().update(mUri, values, null, null);
        }
        ...
        if (rowId == -1) {
            ...
            Toast.makeText(this,
                    String.format(getResources().getString(R.string.pet_saved_successfully), rowId),
    ...
    private void deletePet() {
        int rowNum = 0;
        if (mUri != null) {
            rowNum = getContentResolver().delete(mUri, null, null);
        }
        if (rowNum == -1) {
